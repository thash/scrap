...
require 'pp'
    ...
    here_origin_dir = "/Users/hash/work/file-sync/origin/"

class DateInFileName

    def self.scan_date_in_filename(origin_dir)
        ...
        origin_files.each {|f|
            ...
            #####TODO: return Hash{"filename"} => ["yyyymmdd", "yyyymmdd"...]
    end
end
DateInFileName.scan_date_in_filename(here_origin_dir)
